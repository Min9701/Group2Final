...
namespace Test.Areas.Admin.Controllers
{
    ...
    public class AdminOrdersController : Controller
    {
        ...
        {
            var bookStoreContext = _context.Orders.Include(o => o.Customer).Include(o => o.TransactStatus);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TransactStatusId"] = new SelectList(_context.Statuses, "TransactStatusId", "TransactStatusId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderId,CustomerId,OrderDate,ShipDate,TransactStatusId,Deleted,Paid,PaymentDate,PaymentId,Note")] Order order)
        {
            ...
            ViewData["TransactStatusId"] = new SelectList(_context.Statuses, "TransactStatusId", "TransactStatusId", order.TransactStatusId);
            return View(order);
        }
